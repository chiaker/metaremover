...
```text
https://metaremover.tech/api/plisio/create-invoice
https://metaremover.tech/api/plisio/webhook
```
...
PLISIO_CALLBACK_URL=https://metaremover.tech/api/plisio/webhook?json=true
PLISIO_SUCCESS_URL=https://metaremover.tech/
PLISIO_FAIL_URL=https://metaremover.tech/
...
```env
VITE_PLISIO_CREATE_INVOICE_URL=https://metaremover.tech/api/plisio/create-invoice
VITE_PLISIO_PLAN_NAME=MetaRemover Premium
VITE_PLISIO_PRICE_USD=4.99
VITE_PLISIO_SUCCESS_URL=https://metaremover.tech/?provider=plisio&premium=success
VITE_PLISIO_FAIL_URL=https://metaremover.tech/?provider=plisio&premium=failed
```
...
$env:PLISIO_CALLBACK_URL="https://metaremover.tech/api/plisio/webhook?json=true"
```
...
```text
POST https://metaremover.tech/api/plisio/create-invoice
```
...
```text
https://metaremover.tech/?provider=plisio&premium=success
```

Optional:

```text
https://metaremover.tech/?provider=plisio&premium=success&expires_at=1767225600000&txn_id=abc123
```
...
- For `metaremover.tech`, your deployed backend should expose `POST /api/plisio/create-invoice` and ideally also `POST /api/plisio/webhook`.
